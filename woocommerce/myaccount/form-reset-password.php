...
<form method="post" class="woocommerce-ResetPassword lost_reset_passwor login-containerd">
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last form-field">
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="action action-primary woocommerce-Button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
	</p>
